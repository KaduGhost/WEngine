...
import br.com.redewalker.engine.sistema.economia.EconomiaType;
...
import br.com.redewalker.engine.sistema.economia.EconomiaManager;
	...
	public boolean execute(CommandSender sender, String arg1, String[] args) {
		...
		if (args.length == 0) {
			...
			if (args[0].equalsIgnoreCase("add")) {
				...
				Usuario j2 = WEngine.get().getUsuarioManager().getUsuario(args[2]);
				if (!(j2 instanceof Usuario)) {
					MensagensAPI.jogadorNaoEncontrado(sender);
					return true;
				}
